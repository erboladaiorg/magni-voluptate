...
<p>
  <a aria-label="NPM version" href="https://www.npmjs.com/package/@erboladaiorg/magni-voluptate">
    <img alt="" src="https://img.shields.io/npm/v/@erboladaiorg/magni-voluptate.svg?style=for-the-badge&labelColor=0869B8">
  </a>
  <a aria-label="License" href="#">
    <img alt="" src="https://img.shields.io/npm/l/@erboladaiorg/magni-voluptate.svg?style=for-the-badge&labelColor=579805">
  </a>
  <a aria-label="Thinkmill Logo" href="https://www.thinkmill.com.au/open-source?utm_campaign=github-@erboladaiorg/magni-voluptate">
...
There is also a [Changelog](https://github.com/erboladaiorg/magni-voluptate/blob/master/HISTORY.md).
...
```js
import React, { useState } from 'react';
import classNames from '@erboladaiorg/magni-voluptate';
...
```js
const classNames = require('@erboladaiorg/magni-voluptate/dedupe');
...
```js
const classNames = require('@erboladaiorg/magni-voluptate/bind');
...
import classNames from '@erboladaiorg/magni-voluptate/bind';
